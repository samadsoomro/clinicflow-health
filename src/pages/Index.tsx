              ...
              >
                <CarouselContent className="-ml-4 md:-ml-8 py-4">
                  {reviews.map((review, i) => (
                    <CarouselItem key={review.id} className="pl-4 md:pl-8 md:basis-1/3">
                      <motion.div
                        custom={i}
                        initial="hidden"
                        whileInView="visible"
                        ...
                        variants={fadeUp}
                        whileHover={{ y: -5 }}
                        className="bg-card rounded-3xl shadow-lg border border-border/60 p-8 flex flex-col h-full transition-all duration-300 hover:shadow-xl hover:border-yellow-400/30 group"
                      >
                        {/* Header */}
